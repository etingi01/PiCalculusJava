...
public class ParallelProc12 implements CSProcess {
	 public String nameProcess = "ParallelProc12";
	 ...
	 public ParallelProc12( ChannelValue d4, ChannelValue up2, ChannelValue up1, ChannelValue up4, ChannelValue up3, ChannelValue d1, ChannelValue d2, ChannelValue d3, ChannelValue fee, ChannelValue f1, ChannelValue u1, ChannelValue f2, ChannelValue send, ChannelValue u2, ChannelValue f3, ChannelValue u3, ChannelValue f4, ChannelValue u4){
			 this.d4 = d4;
			 this.up2 = up2;
			 this.up1 = up1;
			 this.up4 = up4;
	 ...
	 public void run() {
		 while(true){
			 up4.channel.out().write( f4 );
			 d4.channel.out().write( f4 );
		 }
	 }
}
