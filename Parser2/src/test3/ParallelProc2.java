...
public class ParallelProc2 implements CSProcess {
	 ...
	 public ParallelProc2( ChannelValue d4, ChannelValue up2, ChannelValue up1, ChannelValue up4, ChannelValue up3, ChannelValue d1, ChannelValue d2, ChannelValue d3, ChannelValue fee, ChannelValue f1, ChannelValue u1, ChannelValue f2, ChannelValue send, ChannelValue u2, ChannelValue f3, ChannelValue u3, ChannelValue f4, ChannelValue u4){
			 this.d4 = d4;
			 this.up2 = up2;
			 this.up1 = up1;
			 this.up4 = up4;
	 ...
	 public void run() {
			 ParallelProc3 ParP0 = new ParallelProc3(d4, up2, up1, up4, up3, d1, d2, d3, fee, f1, u1, f2, send, u2, f3, u3, f4, u4);
			 ParallelProc10 ParP1 = new ParallelProc10(d4, up2, up1, up4, up3, d1, d2, d3, fee, f1, u1, f2, send, u2, f3, u3, f4, u4);
